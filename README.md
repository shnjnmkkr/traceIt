...
**AI Advisor**
- Groq-powered chat with automatic model fallback (`llama-3.3-70b-versatile`, then `llama-3.1-8b-instant`, then `mixtral-8x7b-32768`)
...
| AI, chat | Groq (Llama 3.3 / 3.1, Mixtral fallback chain) |
